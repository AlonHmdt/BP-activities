<template>
  <div class="home">
    <Search :categoriesMap="categoriesMap" :selectedCategories="selectedCategories" @toggle-category="toggleCategory($event)"/>
    <Timeline :categoriesMap="categoriesMap" :items="items" :selectedCategories="selectedCategories"/>
  </div>
</template>
...
export default {
  ...
  methods: {
      ...
      toggleCategory(categoryId) {
        ...
        this.items.filter(item => this.selectedCategories.indexOf(item.resource_type) > -1);
      }
  }
  ,
  created() {
