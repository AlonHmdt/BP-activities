<template>
  <div class="home">
    <Search :categoriesMap="generateCategories" :selectedCategories="selectedCategories" @toggle-category="toggleCategory($event)" @apply-search="keyword=$event"/>
    <Timeline :categoriesMap="generateCategories" :items="itemsList"/>
  </div>
</template>
